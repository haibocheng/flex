   ...
   */
   public static var netStreamClientClass:Object = fl.video.VideoPlayerClient;
		...
		public function play2(dsi:DynamicStreamItem):void {
			...
			if(dsi.start == -1){
			    // this is a Flex change for a play2() when streaming issue.  We were getting 
			    // "loading, stopped" as the stateChanges, when we should get a "playing" at some point.
			    // Setting _autoPlay = true seems to fix the issue
                //_autoPlay = false;
				_isLive = true;
