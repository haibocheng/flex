...
/**
 *  DropDownListAccImpl is a subclass of AccessibilityImplementation
 *  which implements accessibility for the DropDownList class.
 *
 *  @langversion 3.0
 ...
 */
public class DropDownListAccImpl extends ListBaseAccImpl
{
    ...
    /**
     *  Enables accessibility in the DropDownList class.
     *
     *  <p>This method is called by application startup code
     *  that is autogenerated by the MXML compiler.
     *  Afterwards, when instances of DropDownList are initialized,
    ...
    {
        DropDownList.createAccessibilityImplementation =
            createAccessibilityImplementation;
    }

    /**
     *  @private
     *  Creates a DropDownList AccessibilityImplementation object.
                                ...
                                component:UIComponent):void
    {
        component.accessibilityImplementation =
            new DropDownListAccImpl(component);
    }
     ...
     *  @productversion Flex 4
     */
    public function DropDownListAccImpl(master:UIComponent)
    {
        super(master);
    ...
    /**
     *  @private
     *  IAccessible method for returning the value of the DropDownList
     *  (which would be the text of the item selected).
     *  The DropDownList should return the content of the selected item as the value.
     *
     *  @param childID uint
     *
     *  @return Value String
    ...
    {
        if (childID == 0)
            return getName(DropDownList(master).selectedIndex + 1);
        return null;
    }
    ...
    override public function get_accState(childID:uint):uint
    {
        ...
        if (childID == 0)
        {
            if (DropDownList(master).isDropDownOpen)
    ...
    override protected function eventHandler(event:Event):void
    {
        switch (event.type)
        {
            case "open":
            {
                ...
                var index:uint = DropDownList(master).selectedIndex;
                if (index >= 0)
                {
