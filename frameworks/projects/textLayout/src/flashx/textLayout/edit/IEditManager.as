...
package flashx.textLayout.edit
{
	...
	{				
		 ...
		 * 
		 * <p>TCY, or tate-chuu-yoko, causes text to draw horizontally within a vertical line, and is 
		...
		* @playerversion AIR 1.5
		 ...
		 * 
		 * @see flashx.textLayout.edit.IEditManager.beginCompositeOperation -noswf
		 * 
		 * @playerversion Flash 10
		 * @playerversion AIR 1.5
 	 	 * @langversion 3.0
