...
package flashx.textLayout.elements
{
	...
	* @see TextFlow
	...
	{	
		...
		private var _canMerge:Boolean; 	// true if span is bound to an external data source - generated text
		...
		* @playerversion AIR 1.5
		...
		tlf_internal override function mergeToPreviousIfPossible():Boolean
		{
			...
			if (parent && _canMerge && canReleaseContentElement())
			{
		...
		/** @private */
		override tlf_internal function get canMerge():Boolean
		{
			return _canMerge;
		}
		
		/** @private */
		override tlf_internal function set canMerge(value:Boolean):void
		{
			_canMerge = value;
		}
