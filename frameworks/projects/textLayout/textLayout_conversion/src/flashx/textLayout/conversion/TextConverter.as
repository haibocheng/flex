...
package flashx.textLayout.conversion
{
	...
	public class TextConverter
	{
		 ...
		 * </td>
		 * <td>
		 * The <code>&lt;br&gt;</code> tag creates a line break in the text field. Set the text field to 
		 ...
		 * <strong>Note: </strong> Unlike the TextField class, you cannot use relative point sizes, such as +2 or -4. 
		 * </li>
		 * 
		 * </ul>
		 * 
		 ...
		 * 
		 * <li>
		 * <code>align</code>: Specifies the horizontal alignment of the embedded image within the text field. 
	     	 * Valid values are <code>left</code> and <code>right</code>. The default value is <code>left</code>. 
		 * </li>
		 * </ul>
		 *
		 * <p><strong>Note: </strong> Unlike the TextField class, the following attributes are not supported:
		 * <code>hspace</code>, <code>vspace</code>,  <code>id</code>, and <code>checkPolicyFile</code>.</p>
		 *
		 *  <p>Flash displays media embedded in a text field at full size. To specify the dimensions of the media 
		 * you are embedding, use the <code>&lt;img&gt;</code> tag <code>height</code> and <code>width</code> 
		 * attributes. </p>
		 * 
		 *  <p>In general, an image embedded in a text field appears on the line following the 
		 * <code>&lt;img&gt;</code> tag. However, when the <code>&lt;img&gt;</code> tag 
		 ...
		 * 
		 * <td>
		 * The <code>&lt;p&gt;</code> tag creates a new paragraph. The text field must be set to be a multiline 
		 ...
		 * 
		 * </ul>
		 * <p><strong>Note: </strong> Unlike the TextField class, the following attributes are
		 * unsupported: <code>blockindent</code>, <code>leading</code>, and <code>tabstops</code>.</p>
		 * </td>
		 * </tr>
		 * 
		 * <tr>
