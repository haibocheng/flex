	...
	public final class TextFlowLine implements IVerticalJustificationLine 
	{
       ...
       /** @private 
		...
		private function getSelectionShapesCacheEntry(begIdx:int, endIdx:int, prevLine:TextFlowLine, nextLine:TextFlowLine, blockProgression:String):SelectionCache
		{
			...
			calculateSelectionBounds(drawRects, begIdx, endIdx, blockProgression, heightAndAdj);
		...
		tlf_internal function calculateSelectionBounds(rectArray:Array, begIdx:int, endIdx:int, blockProgression:String, heightAndAdj:Array):void
		{
		...
		private function computePointSelectionRectangle(idx:int, container:DisplayObject, prevLine:TextFlowLine, nextLine:TextFlowLine, constrainSelRect:Boolean):Rectangle
		{
			if (isDamaged() || !_controller)
				return null;
