...
package flashx.textLayout.elements
{
	...
	* @see flashx.textLayout.formats.TextDecoration TextDecoration
	* @see TextFlow
	*/
	...
	public class Configuration implements IConfiguration
	{
		...
		private var _inlineGraphicResolver:Function;
		...
		* @playerversion AIR 1.5
		...
		public function clone():Configuration
		{
			...
			config._inlineGraphicResolver = _inlineGraphicResolver;
			return config; 
		}
		...
		*/
		...
		/** 
		* @copy IConfiguration#inlineGraphicResolver
		* 
		* @playerversion Flash 10
		* @playerversion AIR 1.5
		* @langversion 3.0
		...
		*/		
		...
		{ 
			return _inlineGraphicResolver; 
		}
		public function set inlineGraphicResolver(val:Function):void
		{
			_inlineGraphicResolver = val;
		}
	}
}
