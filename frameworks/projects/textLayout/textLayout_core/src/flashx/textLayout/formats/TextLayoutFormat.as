//========================================================================================
//  $File: //a3t/argon/dev/textLayout_core/src/flashx/textLayout/formats/TextLayoutFormat.as $
//  $DateTime: 2009/08/11 17:14:35 $
//  $Revision: #15 $
//  $Change: 713546 $
//  
//  ADOBE CONFIDENTIAL
...
package flashx.textLayout.formats
{
	...
	public class TextLayoutFormat implements ITextLayoutFormat
	{
		...
		/** @private */
		static private var _trackingLeftProperty:NumberOrPercentProperty = new NumberOrPercentProperty("trackingLeft",0,true,Category.CHARACTER,-100,100,"-100%","100%")
		/** @private */
		static private var _trackingRightProperty:NumberOrPercentProperty = new NumberOrPercentProperty("trackingRight",0,true,Category.CHARACTER,-100,100,"-100%","100%")
		/** @private */
		...
		/** @private */
		static private var _fontFamilyProperty:StringProperty = new StringProperty("fontFamily","Times New Roman",true,Category.CHARACTER);
		/** @private */
		 ...
		 * <p>If undefined during the cascade this property will inherit its value from a parent.</p>
		 * 
		 * @playerversion Flash 10
		 * @playerversion AIR 1.5
		 * @langversion 3.0
		 ...
		 * <p>Legal values as a string are flashx.textLayout.formats.BackgroundColor.TRANSPARENT, flashx.textLayout.formats.FormatValue.INHERIT and from 0x0 to 0xffffffff.</p>
		 * <p>Default value is TRANSPARENT.</p>
		 * <p>Values may be undefined indicating not set.</p>
		 ...
		 * <p>Legal values are from false to true and flashx.textLayout.formats.FormatValue.INHERIT.</p>
		 ...
		 * <p>Legal values are from 0 to 1 and flashx.textLayout.formats.FormatValue.INHERIT.</p>
		 ...
		 * <p>Legal values are from 1 to 720 and flashx.textLayout.formats.FormatValue.INHERIT.</p>
		 * <p>Default value is 12.</p>
		 * <p>Values may be undefined indicating not set.</p>
		 * <p>If undefined during the cascade this property will inherit its value from a parent.</p>
		 * 
		 * @playerversion Flash 10
		 ...
		 * <p>Legal values as a percent are from -1000 to 1000.</p>
		 * <p>Default value is 0.0.</p>
		 * <p>Values may be undefined indicating not set.</p>
		 * <p>If undefined during the cascade this property will inherit its value from a parent.</p>
		 * 
		 * @playerversion Flash 10
		 ...
		 * <p>Legal values as a number are from -100 to 100.</p>
		 * <p>Legal values as a percent are from -100% to 100%.</p>
		 ...
		 * <p>Default value is flashx.textLayout.formats.FormatValue.AUTO.</p>
		 * <p>Values may be undefined indicating not set.</p>
		 * <p>If undefined during the cascade this property will inherit its value from a parent.</p>
		 * 
		 * @playerversion Flash 10
		 ...
		 * <p>Default value is USE_DOMINANT_BASELINE.</p>
		 * <p>Values may be undefined indicating not set.</p>
		 * <p>If undefined during the cascade this property will inherit its value from a parent.</p>
		 ...
		 * <p>Default value is Times New Roman.</p>
		 * <p>Values may be undefined indicating not set.</p>
		 * <p>If undefined during the cascade this property will inherit its value from a parent.</p>
		 * 
		 * @playerversion Flash 10
		...
		/**
		 * Collapses or preserves whitespace when importing text into a TextFlow (adopts parent's value if undefined during cascade). <code>WhiteSpaceCollapse.PRESERVE</code> retains all whitespace characters. <code>WhiteSpaceCollapse.COLLAPSE</code> removes newlines, tabs, and leading or trailing spaces within a block of imported text. Line break tags (<br/>) and Unicode line separator characters are retained.
		 ...
		 * <p>Default value is HORIZONTAL_STEM.</p>
		 * <p>Values may be undefined indicating not set.</p>
		 * <p>If undefined during the cascade this property will inherit its value from a parent.</p>
		 * 
		 * @playerversion Flash 10
		 ...
		 * <p>Legal values are from -1000 to 1000 and flashx.textLayout.formats.FormatValue.INHERIT.</p>
		 * <p>Default value is 0.</p>
		 * <p>Values may be undefined indicating not set.</p>
		 * <p>If undefined during the cascade this property will inherit its value from a parent.</p>
		 * 
		 ...
		 * <p>Legal values are from 0 to 1000 and flashx.textLayout.formats.FormatValue.INHERIT.</p>
		 * <p>Default value is 0.</p>
		 * <p>Values may be undefined indicating not set.</p>
		 * <p>If undefined during the cascade this property will inherit its value from a parent.</p>
		 * 
		 ...
		 * <p>Default value is INTER_WORD.</p>
		 * <p>Values may be undefined indicating not set.</p>
		 * <p>If undefined during the cascade this property will inherit its value from a parent.</p>
		 * 
		 * @playerversion Flash 10
		 ...
		 * <p>Legal values as a string are flashx.textLayout.formats.FormatValue.AUTO, flashx.textLayout.formats.FormatValue.INHERIT and from 1 to 50.</p>
		 * <p>Default value is AUTO.</p>
		 * <p>Values may be undefined indicating not set.</p>
		 * <p>If undefined during the cascade this property will have its default value.</p>
		 * 
		 ...
		 * <p>Legal values as a string are flashx.textLayout.formats.FormatValue.AUTO, flashx.textLayout.formats.FormatValue.INHERIT and from 0 to 8000.</p>
		 * <p>Default value is AUTO.</p>
		 * <p>Values may be undefined indicating not set.</p>
		 * <p>If undefined during the cascade this property will have its default value.</p>
		 * 
		 ...
		 * The offset from the top inset (or right inset if <code>blockProgression</code> is RL) of the container to the baseline of the first line can be either <code>BaselineOffset.ASCENT</code>, meaning equal to the ascent of the line, <code>BaselineOffset.LINE_HEIGHT</code>, meaning equal to the height of that first line, or any fixed-value number to specify an absolute distance. <code>BaselineOffset.AUTO</code> aligns the ascent of the line with the container top inset.<p><img src='../../../images/textLayout_FBO1.jpg' alt='firstBaselineOffset1' /><img src='../../../images/textLayout_FBO2.jpg' alt='firstBaselineOffset2' /><img src='../../../images/textLayout_FBO3.jpg' alt='firstBaselineOffset3' /><img src='../../../images/textLayout_FBO4.jpg' alt='firstBaselineOffset4' /></p>
		 * <p>Legal values as a string are flashx.textLayout.formats.BaselineOffset.AUTO, flashx.textLayout.formats.BaselineOffset.ASCENT, flashx.textLayout.formats.BaselineOffset.LINE_HEIGHT, flashx.textLayout.formats.FormatValue.INHERIT and from 0 to 1000.</p>
		 * <p>Default value is AUTO.</p>
		 * <p>Values may be undefined indicating not set.</p>
		 * <p>If undefined during the cascade this property will inherit its value from a parent.</p>
		 * 
		 ...
		 * with the values of this TextLayoutFormat object. Properties whose values are <code>undefined</code> in this
		 * (the receiving) TextLayoutFormat object will get new values if they are <em>not</em> <code>undefined</code> in
