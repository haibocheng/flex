...
package flashx.textLayout.property
{
	...
	public class Property
	{
		...
		public static const inheritHashValue:uint  = 314159;
		public static var   nextEnumHashValue:uint = 217287;
		...
		{
			CONFIG::debug { assert(newVal !== null || defaultValue === null,"Property.setHelper - null passed in did you mean undefined?"); }
			return newVal; 
		}
		...
		/** Compute the value of a property from the input string. 
		 * @return actual value of the property.  null if str is not a legal value. */
		public function valueFromString(str:String):*
