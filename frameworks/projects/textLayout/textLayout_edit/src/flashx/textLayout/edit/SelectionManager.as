...
package flashx.textLayout.edit
{
	...
	{		
		...
		*/
		...
		private function internalSetSelection(root:TextFlow,anchorIndex:int,activeIndex:int,format:ITextLayoutFormat = null) : void
		{
			_textFlow = root;
		...
		private function internalSetSelectionInternal(root:TextFlow,begIdx:int,endIdx:int,format:ITextLayoutFormat = null) : void
		{
			_textFlow = root;
		...
		*/
		...
		static private function computeSelectionIndexInContainer(textFlow:TextFlow, controller:ContainerController, localX:Number, localY:Number):int
		{
			...
			var distance:Number = 32000; //a number larger than a reasonable screen size
		...
		*/
		...
		{
			internalSetSelectionInternal(tf, begIdx, endIdx);
