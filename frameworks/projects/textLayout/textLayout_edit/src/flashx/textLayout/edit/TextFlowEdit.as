...
[ExcludeClass]
	...
	public class TextFlowEdit
	{
		...
		private static function insertTextFlow(theFlow:TextFlow, pos:int, insertedTextFlow:FlowGroupElement, missingBeginElementsInFlow:Array = null, missingEndElementsInFlow:Array = null, separatorArray:Array = null):int
		{
				...
				(insertedTextFlow is TextFlow))
			{
				...
				{	
					...
					if (okToMergeWithAfter && missingEnd && joinNextParagraph(ParagraphElement(insertedTextFlow)))
					{
						//merge the paragraph with what comes next.
		...
		{
			var numCharsAdded:int = 0;
			var numCharsDeleted:int = 0;
		 ...
		 * 
		 */
		internal static function insertNewSPBlock(theFlow:TextFlow, startPos:int, endPos:int, newSPB:SubParagraphGroupElement, spgClass:Class):Boolean
		{
		 ...
		 */
		internal static function splitElement(elem:FlowElement, splitPos:int, splitSubBlockContents:Boolean):void
		{
		 ...
		 */
		internal static function findAndSplitElement(fbe:FlowGroupElement, elementIdx:int, startIdx:int, splitSubBlockContents:Boolean):int
		{
		 ...
		 *  newSPB is of type <b>
		 */
		internal static function subsumeElementsToSPBlock(parentFBE:FlowGroupElement, elementIdx:int, curPos:int, endPos:int, newSPB:SubParagraphGroupElement, spgClass:Class):int
		{
			var curFlowEl:FlowElement = null;
		 ...
		 */ 
		internal static function findAndRemoveFlowGroupElement(theFlow:TextFlow, startPos:int, endPos:int, fbeClass:Class):Boolean
		{
			var curPos:int = startPos;
		 ...
		 */
		internal static function canInsertSPBlock(theFlow:TextFlow, startPos:int, endPos:int, blockClass:Class):Boolean
		{
			if(endPos <= startPos)
				return false;
		...
		/**
		 * @internal flushSPBlock recursively walk a spg looking for elements of type spgClass.  On finding one,
		 ...
		 */ 
		internal static function flushSPBlock(subPB:SubParagraphGroupElement, spgClass:Class):void
		{
