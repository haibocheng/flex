		...
		*/
		...
		private function doInternal():void
		{
			...
			//	CONFIG::debug { if (begSel != absoluteStart || endSel != absoluteEnd) trace("found mismatch ApplyFormatOperation"); }
				...
				ParaEdit.applyTextStyleChange(textFlow,begSel,endSel,applyLeafFormat);
			}
			...
			if (applyParagraphFormat)
			{
				...
				ParaEdit.applyParagraphStyleChange(textFlow,absoluteStart, absoluteEnd,applyParagraphFormat);
			}
			if (applyContainerFormat)
			{
				...
				ParaEdit.applyContainerStyleChange(textFlow,absoluteStart,absoluteEnd,applyContainerFormat);
			}
		}
