...
package flashx.textLayout.operations
{
	...
	public class InsertTextOperation extends FlowTextOperation
	{
		 ...
		 * @playerversion AIR 1.5
	 	 * @langversion 3.0 
		 */	
		function InsertTextOperation(operationState:SelectionState, text:String, deleteSelectionState:SelectionState = null)
		{
		...
		public override function doOperation():Boolean
		{
			...
			if (delSelOp != null) {	
				...
				if (delSelOp.doOperation())		// figure out what to do here
				{
					...
					{
						tcyEl.replaceChildren(0,0,new SpanElement());
					}
				} 
			} 
			...
			if (_characterFormat && !TextLayoutFormat.isEqual(_characterFormat, range.firstLeaf.format))
				ParaEdit.applyTextStyleChange(textFlow,absoluteStart,absoluteStart+_text.length,_characterFormat);
