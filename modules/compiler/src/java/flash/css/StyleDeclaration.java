...
public class StyleDeclaration
{
    ...
    // TODO: Delete as these appear to no longer be used... 
    /*
    public Descriptor removeDescriptor(String name)
    {
        priorities.remove(name);
    ...
    public String getDescriptorPriority(String propertyName)
    {
        return priorities.get(propertyName);
    }
    ...
    {
        return (Descriptor)descriptors.get(descriptors.get(i));
    }
