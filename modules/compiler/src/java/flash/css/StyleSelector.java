...
/**
 * Selectors are used to match style declarations to components. Supported
 * selectors include simple type selectors, conditional (based on the identity,
 * styleName (class) or state (pseudo-element) of a component), or descendant
 * (based on the position in the display list). 
 */
