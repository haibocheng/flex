...
public class As3Compiler extends AbstractSubCompiler implements flex2.compiler.SubCompiler
{
	...
	public void analyze2(CompilationUnit unit, SymbolTable symbolTable)
	{
		...
		if (as3Configuration != null && as3Configuration.strict())
		{
	...
	public void analyze3(CompilationUnit unit, SymbolTable symbolTable)
	{
        ...
        if (as3Configuration != null && (as3Configuration.strict() || as3Configuration.warnings()))
        {
		...
		if (true /*configuration.metadataExport()*/ && ! unit.getSource().isInternal())
        {
            ...
            macromedia.asc.parser.MetaDataEvaluator printer = new macromedia.asc.parser.MetaDataEvaluator(as3Configuration.debug());
	...
	public void analyze4(CompilationUnit unit, SymbolTable symbolTable)
	{
		...
		if (as3Configuration != null && as3Configuration.warnings())
		{
			cx.pushScope(node.frame);
	...
	public void generate(CompilationUnit unit, SymbolTable symbolTable)
	{
		...
		Emitter emitter = new BytecodeEmitter(cx, unit.getSource(),
		                                      as3Configuration != null && as3Configuration.debug(),
		                                      (as3Configuration != null && as3Configuration.adjustOpDebugLine()) ? map : null);
...
//	}
	...
	private void processCoachSettings()
	{
		if (warnMap == null)
		{
			...
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_ArrayToStringChanges), as3Configuration.warn_array_tostring_changes() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_AssignmentWithinConditional), as3Configuration.warn_assignment_within_conditional() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_BadArrayCast), as3Configuration.warn_bad_array_cast() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_BadBoolAssignment), as3Configuration.warn_bad_bool_assignment() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_BadDateCast), as3Configuration.warn_bad_date_cast() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_BadES3TypeMethod), as3Configuration.warn_bad_es3_type_method() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_BadES3TypeProp), as3Configuration.warn_bad_es3_type_prop() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_BadNaNComparision), as3Configuration.warn_bad_nan_comparison() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_BadNullAssignment), as3Configuration.warn_bad_null_assignment() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_BadNullComparision), as3Configuration.warn_bad_null_comparison() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_BadUndefinedComparision), as3Configuration.warn_bad_undefined_comparison() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_BooleanConstructorWithNoArgs), as3Configuration.warn_boolean_constructor_with_no_args() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_ChangesInResolve), as3Configuration.warn_changes_in_resolve() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_ClassIsSealed), as3Configuration.warn_class_is_sealed() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_ConstNotInitialized), as3Configuration.warn_const_not_initialized() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_ConstructorReturnsValue), as3Configuration.warn_constructor_returns_value() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_DepricatedEventHandlerError), as3Configuration.warn_deprecated_event_handler_error() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_DepricatedFunctionError), as3Configuration.warn_deprecated_function_error() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_DepricatedPropertyError), as3Configuration.warn_deprecated_property_error() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_DuplicateArgumentNames), as3Configuration.warn_duplicate_argument_names() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_DuplicateVariableDef), as3Configuration.warn_duplicate_variable_def() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_ForVarInChanges), as3Configuration.warn_for_var_in_changes() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_ImportHidesClass), as3Configuration.warn_import_hides_class() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_InstanceOfChanges), as3Configuration.warn_instance_of_changes() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_InternalError), as3Configuration.warn_internal_error() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_LevelNotSupported), as3Configuration.warn_level_not_supported() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_MissingNamespaceDecl), as3Configuration.warn_missing_namespace_decl() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_NegativeUintLiteral), as3Configuration.warn_negative_uint_literal() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_NoConstructor), as3Configuration.warn_no_constructor() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_NoExplicitSuperCallInConstructor), as3Configuration.warn_no_explicit_super_call_in_constructor() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_NoTypeDecl), as3Configuration.warn_no_type_decl() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_NumberFromStringChanges), as3Configuration.warn_number_from_string_changes() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_ScopingChangeInThis), as3Configuration.warn_scoping_change_in_this() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_SlowTextFieldAddition), as3Configuration.warn_slow_text_field_addition() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_UnlikelyFunctionValue), as3Configuration.warn_unlikely_function_value() ? Boolean.TRUE : Boolean.FALSE);
			warnMap.put(IntegerPool.getNumber(WarningConstants.kWarning_XML_ClassHasChanged), as3Configuration.warn_xml_class_has_changed() ? Boolean.TRUE : Boolean.FALSE);
		}
	}
}
