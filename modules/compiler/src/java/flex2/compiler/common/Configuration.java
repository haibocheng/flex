...
public class Configuration implements LinkerConfiguration, Cloneable
{
    ...
    {
        Collection<String> compilerExterns = compiler.getExterns();
    ...
    */
	...
	private int majorVersionTarget = 10;
    ...
    public boolean getQualifiedTypeSelectors()
    {
 	    ...
 	    throws CloneNotSupportedException
 	{
 	    ...
 	    CompilerConfiguration cloneCompiler = (CompilerConfiguration) this.compiler.clone();
 	    cloneConfig.compiler = cloneCompiler;
 	    return cloneConfig;
 	}
}
