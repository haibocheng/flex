...
class VectorBuilder extends AbstractBuilder
{
    ...
    protected class ElementNodeHandler extends ValueNodeHandler
    {
        ...
        {
            String typeAttribute = (String) node.getAttribute(StandardDefs.PROP_TYPE).getValue();
            Type elementType = typeTable.getType(NameFormatter.toColon(typeAttribute));
    ...
    public void processTextInitializer(String text, Type vectorElementType, boolean cdata, int line)
    {
        ...
        Object result = textParser.parseValue(text, typeTable.vectorType, vectorElementType, flags, line, typeTable.vectorType.getName());
