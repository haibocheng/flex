...
public class TypeTable
{
    ...
    public Type getType(String className)
    {
        ...
        if (t == null)
        {
            ...
            if (classInfo != null)
            {
                t = new TypeHelper(classInfo, standardDefs);
            ...
            else
            {
                ...
                if (lessThanIndex != -1)
                {
                    ...
                    if (greaterThanIndex != -1)
                    {
                        ...
                        if (elementType != null)
                        {
                            t = new TypeHelper(symbolTable.getClass(SymbolTable.VECTOR), elementType, standardDefs);
                            typeMap.put(className, t);
                        }
                    }
                }
    ...
    private final class TypeHelper implements Type
    {
        ...
        private Method findGetter(AbcClass cls, Method setter)
        {
            while (cls != null)
            {
                Method getter = cls.getGetter(new String[] {SymbolTable.publicNamespace},
                                              setter.getQName().getLocalPart(), true);
                if (getter != null)
                {
                    return getter;
                }
        ...
        private Method findSetter(AbcClass cls, Method getter)
        {
            while (cls != null)
            {
                Method setter = cls.getSetter(new String[] {SymbolTable.publicNamespace},
                                              getter.getQName().getLocalPart(), true);
                if (setter != null)
                {
                    return setter;
                }
    ...
    private final class PropertyHelper extends StatefulHelper implements Property
    {
        ...
        public String getName()
        {
            if (var != null)
            {
                return var.getQName().getLocalPart();
            }
            else if (setter != null)
            {
                return setter.getQName().getLocalPart();
            }
            else // if (getter != null)
            {
                return getter.getQName().getLocalPart();
            }
        }
        ...
        public Type getElementType()
        {
            if (elementType == null)
            {
                ...
                if (getType().equals(vectorType))
                {
                    if (var != null)
                    {
                        elementTypeName = var.getElementTypeName();
                    }
                    else if (setter != null)
                    {
                        elementTypeName = setter.getParameterElementTypeNames()[0];
                    }
                    else // if (getter != null)
                    {
                        elementTypeName = getter.getReturnElementTypeName();
                    }
                }
                else
                {
