...
public class BindingExpression implements Comparable<BindingExpression>
{
     ...
     *
     * @param includeElementType If true and the destination type is
     *                           Vector, then the element type is
    ...
    public String getDestinationTypeName(boolean includeElementType)
    {
            ...
            if (destinationProperty != null)
            {
                ...
                if (!destinationType.getName().equals(mxmlDocument.getStandardDefs().CLASS_OBJECTPROXY))
                {
                    ...
                    if (property != null)
                    {
                        ...
                        if (type.equals(mxmlDocument.getTypeTable().vectorType))
                        {
        ...
        if (type != null)
        {
            ...
            {
                result += ".<" + NameFormatter.toDot(elementType.getName()) + ">";
            }
        }
