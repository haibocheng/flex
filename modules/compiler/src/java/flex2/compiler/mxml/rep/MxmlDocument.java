 ...
 * AbstractDocumentBuilder's analysis of the DOM.
 *
...
public final class MxmlDocument
{
    ...
    {
        addDeclaration(id, typeName, line, inspectable, topLevel, idIsAutogenerated, null);
    }
    ...
    public final void addDeclaration(String id, String typeName, int line, boolean inspectable, boolean topLevel, boolean idIsAutogenerated, String comment)
    {
        ...
        {
            declarations.put(id, new UninitializedPropertyDeclaration(id, typeName, line, inspectable, topLevel, idIsAutogenerated, comment));
        }
    }    
   ...
   /**
    ...
    private final void ensureBindingImports()
    {
        if (!bindingImportsAdded)
        {
            for (Iterator<BindingExpression> iter = bindingExpressions.iterator(); iter.hasNext(); )
            {
                ...
                addImport(expr.getDestinationTypeName(false), expr.getXmlLineNumber());
            }
    ...
    public void resolveTwoWayBindings()
    {
        ...
        for (BindingExpression bindingExpression : bindingExpressions)
        {
            ...
            //System.err.println("resolveTwoWayBinding: source=" + sourceExpression + " dest=" + destinationPath + " twoWay=" + (match != null));
