...
public class SwcAPI
{
    public static List<SwcComponent> setupNamespaceComponents(CompcConfiguration configuration, NameMappings mappings, SourcePath sourcePath, Map<String, Source> classes)
            throws ConfigurationException, CompilerException
    {
        return setupNamespaceComponents(configuration.getNamespaces(), mappings, sourcePath, classes, configuration.getIncludeLookupOnly(), false);
    }

    public static List<SwcComponent> setupNamespaceComponents(List targets, NameMappings mappings, SourcePath sourcePath, Map<String, Source> classes)
        throws ConfigurationException, CompilerException
    {
        return setupNamespaceComponents(targets, mappings, sourcePath, classes, false, false);
    }
     ...
     */
    public static List<SwcComponent> setupNamespaceComponents(List targets, NameMappings mappings, SourcePath sourcePath, Map<String, Source> classes, boolean includeLookupOnly, boolean includeAllForAsdoc)
            throws ConfigurationException, CompilerException
    {
    ...
    public static void setupClasses(CompcConfiguration configuration, SourcePath sourcePath, Map<String, Source> classes)
        throws CompilerException
    {
        setupClasses(configuration.getClasses(), sourcePath, classes);
    }

    public static void setupClasses(List list, SourcePath sourcePath, Map<String, Source> classes)
        throws CompilerException
    {
        if (list != null)
        {
