...
import flex2.compiler.extensions.IExtension;
...
public class Compc extends Tool
{
    ...
    public static Benchmark compc( ConfigurationBuffer cfgbuf, CompcConfiguration configuration )
        throws Exception, ConfigurationException, CompilerException, LicenseException
    {
        ...
        List<SwcComponent> nsComponents = SwcAPI.setupNamespaceComponents(configuration, mappings, sourcePath, classes);
        SwcAPI.setupClasses(configuration, sourcePath, classes);
                ...
                finally
                {
                    if (incrementalFile != null)
                    {
                        ...
                        if (recompile)
                        {
                            ...
                            nsComponents = SwcAPI.setupNamespaceComponents(configuration, mappings, sourcePath, classes);
                            SwcAPI.setupClasses(configuration, sourcePath, classes);
                        }
                    }
                }
