...
public class Fcsh extends Tool
{
    ...
    private static void compile_compc(SwcTarget s)
    {
        ...
        try
        {
                                                     ...
                                                     swcContext, s.classes, s.perCompileData, recompile, configuration) > 0)
            {
                ...
                s.nsComponents = SwcAPI.setupNamespaceComponents(configuration, mappings, s.sourcePath, classes);
                SwcAPI.setupClasses(configuration, s.sourcePath, classes);
    ...
    private static void compc(String[] args, int id)
    {
        ...
        try
        {
            ...
            s.nsComponents = SwcAPI.setupNamespaceComponents(configuration, mappings, s.sourcePath, s.classes);
            SwcAPI.setupClasses(configuration, s.sourcePath, s.classes);
