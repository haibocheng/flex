...
public class PostLink implements flex2.linker.PostLink
{
	...
	public PostLink(LinkerConfiguration linkerConfiguration)
	{
		...
		keepDebugOpcodes = linkerConfiguration.keepDebugOpcodes();
	...
	private void merge(List<DoABC> doABCs, boolean keepDebugOpcodes, boolean runPeephole, String name)
	{
		Encoder encoder;
		Decoder decoder;
	...
	//    before we ship.
	private void merge(List<byte[]> abcList, boolean keepDebugOpcodes, boolean runPeephole)
	{
		Encoder encoder;
		Decoder decoder;
