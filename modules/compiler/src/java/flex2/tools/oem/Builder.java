...
public interface Builder
{
    ...
    /**
     * Sets the SWC cache to be shared by all the applications and libraries in the current project.
     *
     * @param swcCache The cache.
     */
    void setSwcCache(LibraryCache swcCache);
