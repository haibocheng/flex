...
public class DOMParserHelper
{
    ...
    public static double parseDouble(FXGNode node, String value, String name, double min, double max, double defaultValue)
    {
        ...
        if (((AbstractFXGNode)node).isVersionGreaterThanCompiler())
        {
            ...
            FXGLog.getLogger().log(FXGLogger.WARN, "DefaultAttributeValue", null, ((AbstractFXGNode)node).getDocumentName(), node.getStartLine(), node.getStartColumn());
            return defaultValue;
        }
        else
        {
     ...
     * InterpolationMethod.
     */
    public static InterpolationMethod parseInterpolationMethod(FXGNode node, String value, InterpolationMethod defaultValue)
    {
     ...
     * MaskType.
     */
    public static MaskType parseMaskType(FXGNode node, String value, MaskType defaultValue)
    {
     ...
     * fillMode value.
     */
    public static FillMode parseFillMode(FXGNode node, String value, FillMode defaultValue)
    {
     ...
     * SpreadMethod.
     */
    public static SpreadMethod parseSpreadMethod(FXGNode node, String value, SpreadMethod defaultValue)
    {
     ...
     */
    public static String parseIdentifier(FXGNode node, String value, String defaultValue)
    {
        Matcher m;
