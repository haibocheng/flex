...
public class LinearGradientFillNode extends AbstractFillNode implements ScalableGradientNode
{
    ...
    public void addChild(FXGNode child)
    {
        ...
        else if (child instanceof GradientEntryNode)
        {
            ...
            {
            	//Exception:A LinearGradient cannot define more than 16 GradientEntry elements.
                throw new FXGException(child.getStartLine(), child.getStartColumn(), "InvalidLinearGradientNumElements");
            }
