...
public class RadialGradientStrokeNode extends AbstractStrokeNode implements ScalableGradientNode
{
    ...
    public void addChild(FXGNode child)
    {
        ...
        else if (child instanceof GradientEntryNode)
        {
            ...
            {
            	//Exception:A RadialGradientStroke cannot define more than 16 GradientEntry elements.
                throw new FXGException(child.getStartLine(), child.getStartColumn(), "InvalidRadialGradientStrokeNumElements");
            }
