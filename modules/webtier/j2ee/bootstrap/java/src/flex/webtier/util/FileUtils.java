...
/**
 * General utility to help with common File operations.
 *
 * This class is in the bootstrap as it is used by our sample jsp
 * code to normalize paths to avoid attempts to traverse parent
 * directories with non-canonicalized URLs.
 *
